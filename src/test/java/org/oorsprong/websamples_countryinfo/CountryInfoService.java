 ...
 * 2017-07-30T19:19:42.849+03:00
 * Generated source version: 3.1.12
 * 
 */
@WebServiceClient(name = "CountryInfoService", 
                  wsdlLocation = "file:/home/ooktay/work/blank-bdd/src/test/resources/wsdl/SampleWS.wsdl",
...
public class CountryInfoService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/ooktay/work/blank-bdd/src/test/resources/wsdl/SampleWS.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CountryInfoService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/ooktay/work/blank-bdd/src/test/resources/wsdl/SampleWS.wsdl");
        }
        WSDL_LOCATION = url;
    }
